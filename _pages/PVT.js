//<![CDATA[
	...
	var testDuration= 1; //default test time is 2 minutes
	...
	function handleMouseDown(evt)
	{
  		...
  		//printDebug("response time= "+rTime);
			// 16-Nov-2022 SAMRAN: following line prints the response time on screen after each trial
	...
	function startEntireTest(){
		document.getElementById("buttons").innerHTML='<input type= "button" id="stop" value="" onclick="" />';
